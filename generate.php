...
$linka = 'http://dizist.net/izle/Mr.-Robot-2-sezon-5-bolum/';
...
$datb =file_get_contents($linkb);

$titlu = explode('" class="button realcuf"><b>Ru</b>', $datb);

$titlo = explode('<a href="', $titlu[0]);


$ahmet= "http://dizist.net";

$ahmet.= end($titlo);

//echo $ahmet;

//echo "<pre>"; print_r($titlo);


$data = file_get_contents($ahmet);


$title = explode('<iframe rel=', $data);


$titla = explode('</iframe>',$title[2]);
...
<form action="<?=$_SERVER['PHP_SELF'];?>" method="post">
 <input type="button" name="submit" value="getir" style="background-color: green; color:pink; border-radius: 10%;" onclick="kk();">
          ...
          <a href="<?php echo $linkb; ?>">Click if not working</a
          <br>
        <br>
        <br>
        
       <iframe rel=<?php echo $link ?></iframe>
...
<br>
<div class="footer" style="color:gray	; text-align:center;">
<?php echo 'Mehmet Can © 2016' ?>
